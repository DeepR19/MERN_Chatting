...
const Options = () => {
  ...
  return (
    <>
     <Tooltip title="Use media link to share CODE with friends or other">
          <InfoCircleOutlined style={{ color: "rgba(0,0,0,.8)",position: 'absolute', bottom: '20px', right: '20px' ,fontSize: '20px'}} />
      </Tooltip>
    ...
    <div className={classes.options}>
        ...
        <div className={classes.share_options}>
          ...
          <div className={classes.share_social}>
            ...
            <EmailShareButton
              ...
              className={classes.share_icon}
            >
              <EmailIcon size={26} round className={classes.share_border} />
            </EmailShareButton>
          </div>
        </div>
      </div>
      <div style={{ marginBottom: "0.5rem" }}>
        ...
        <Input placeholder="Enter code to call"
          size="large"
          className={classes.inputgroup}
          value={idToCall}
